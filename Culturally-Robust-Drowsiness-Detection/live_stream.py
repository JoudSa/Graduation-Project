...
#  COLORS (BGR)
# ──────────────────────────────────────────────
COLOR_OPEN    = (50, 220, 100)
COLOR_CLOSED  = (50, 100, 255)
COLOR_ALERT   = (0, 0, 255)
COLOR_CRITICAL= (0, 0, 200)
COLOR_SAFE    = (50, 220, 100)
COLOR_TEXT    = (255, 255, 255)
COLOR_BG      = (20, 20, 30)


# ──────────────────────────────────────────────
#  BUILT-IN BEEP GENERATOR (no wav or mp3 file needed)
# ──────────────────────────────────────────────
SAMPLE_RATE = 44100
...
def main():
    ...
    class_names = model.names  # {0: 'closed', 1: 'open'}
